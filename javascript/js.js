...
axios.get("http://localhost:5001/filmes").
then(response => {
...
function deleteFilme(listItem){
    ...
    axios.delete(`http://localhost:5001/filmes/${id}`).
    then(response => {
...
axios.post("http://localhost:5001/filmes", filme).then(response =>{
...
if (response.status ==201){
    ...
    function updateMovie(){
        ...
        axios.put(`http://localhost:5001/filmes/${id}`, filme).then(response => {
